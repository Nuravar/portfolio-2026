            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
              ...
              <div className="space-y-6">
                <div className="space-y-2">
                  <h1 className="blog-title">Keysight</h1>
                </div>

                <p className="text-xl lg:text-2xl text-gray-300 leading-relaxed">
                  Created a two-part web security device that allows homeowners
                  to track movement in and out of their household using facial
              ...
              <div className="space-y-4">
                      ...
                      <Tooltip>
                        <TooltipTrigger asChild>
                          <button
                            onClick={() =>
                              window.open(
                                "https://www.linkedin.com/in/himanshu-singh03/",
                                "_blank"
                              )
                            }
                            className="transition-transform hover:scale-110 hover:z-10 relative"
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-gray-300 text-base leading-relaxed">
                    Home Security • Facial Recognition • Voice Recognition • Web
                    Development • Real-Time Notifications • Firebase Integration
                    • gRPC Communication • Raspberry Pi Hardware Control • UI/UX
                    Design (Figma) • React Application
                  </p>
                </div>
                ...
                <div className="space-y-3 pt-2">
                  <ExternalLinkCard
                    title="Devpost"
                    description="See our Devpost project page!"
                    url="https://devpost.com/software/keysight"
                  />
                  <ExternalLinkCard
                    title="GitHub"
                    description="Check out the Keysight's GitHub repository."
          ...
          <div className="p-6 lg:p-12 max-w-4xl mx-auto">
            <article className="space-y-6">
              ...
              <section className="space-y-6">
                ...
                <p>
                  Whether you are at work or at home, the nagging worry of
                  "who's at home?" fades away but it is hard to truly understand
                  what is going on where you relax. Research labs, punch-in
                  machines, and traditional home cameras not only are slow to
                  use but provide limited data as to who is moving in and out of
                  your house.
                </p>
              </section>
              ...
              <section className="space-y-6">
                ...
                <ul className="custom-ul">
                  ...
                  <li className="custom-li">
                    <span>
                      Connected the frontend React app to the Firebase backend
                    </span>
                  </li>
                  <li className="custom-li">
                    <span>
                      Integrated communication to a Raspberry Pi via gRPC
                    </span>
                  </li>
                </ul>
              </section>
              ...
              <section className="space-y-6">
                <h2>Outcome</h2>
                <p>
                  Keysight is a two-part web security system that allows
                  homeowners to monitor and track movement in and out of their
                  household. Utilizing facial recognition and voice detection,
                  Keysight is able to quickly identify whitelisted individuals
                  as well as send notifications alerting of any guests or
                  deliveries. Whenever there is any abnormal activity or
                  threats, everyone in your house will be notified safely and
                  remotely.
                </p>
              ...
              <section className="space-y-6">
                <h2>Final Web Application Mockup</h2>
                <p>
                  Keysight was built using a combination of React, Firebase, and
                  Chakra UI through UI/UX designs created in Figma. Firebase was
                  utilized as the database to document and log user information
                  that was initialized through Google authentication. We chose
                  React as our main framework due to its ability for hot refresh
                  alongside Firebase.
                </p>
                <p>
                  Our design consists of a main dashboard that showcases all
                  main information alongside a settings tab that allows for
                  group creation through email invites.
                </p>
